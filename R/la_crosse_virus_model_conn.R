#' la_crosse_virus_model_conn() habia una vez ...
#'
...
#' if( as.integer( exists) ){ print("Exists!") }else{ la_crosse_virus_model_conn(tableData, disease, conn, degree) }
#' RPostgres::dbDisconnect(conn)
#' @export
la_crosse_virus_model_conn <- function(tableData, disease, conn, degree){
  library(RcppOctave)
