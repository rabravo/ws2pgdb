...
#' if( as.integer( exists) ){ print("Exists!") }else{ chikungunya_model_conn(tableData, disease, conn, degree) }
#' RPostgres::dbDisconnect(conn)
#' @export
chikungunya_model_conn <- function(tableData, disease, conn, degree){
  library(RcppOctave)
